...
static bool ImGui_ImplWin32_UpdateMouseCursor(ImGuiIO& io, ImGuiMouseCursor imgui_cursor, bool indirect = true)
{
    ...
    if (imgui_cursor == ImGuiMouseCursor_None || io.MouseDrawCursor)
    {
      ...
      if (indirect)
        ::PostMessage(bd->hWnd, WM_USER_SET_CURSOR, NULL, NULL);
      else
        ::SetCursor(NULL);
    ...
    else
    {
        ...
        if (indirect)
          ::PostMessage(bd->hWnd, WM_USER_SET_CURSOR, NULL, (LPARAM)win32_cursor);
        else
